...
<!-- DataTales Example -->
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold">{% if row is defined and row.id is defined %}{{ locale._("Edit") }} {{ locale._("Group") }} {{ row.id }}{% else %}{{ locale._("Create New") }} {{ locale._("Group") }}{% endif %}</h6>
        </div>
        <div class="card-body">
            <form method="post" >
